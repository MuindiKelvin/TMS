		...
		<div class="four-grids">
					<div class="col-md-3 four-grid">
						<div class="four-agileits">
							<div class="icon">
								<a href="manage-users.php" class="block-anchor panel-footer text-center" >Full Detail &nbsp; <i class="fa fa-arrow-right"></i></a>
...
$cnt1=$query1->rowCount();
					...
					<div class="col-md-3 four-grid">
						<div class="four-w3ls">
							<div class="icon">
								<a href="manage-enquires.php" class="block-anchor panel-footer text-center" >Full Detail &nbsp; <i class="fa fa-arrow-right"></i></a>
...
$cnt3=$query3->rowCount();
		...
		<div class="four-grids">
					<div class="col-md-3 four-grid">
						<div class="four-w3ls">
							<div class="icon">
								<a href="manageissues.php" class="block-anchor panel-footer text-center" >Full Detail &nbsp; <i class="fa fa-arrow-right"></i></a>
